...
layout1 = [
    ...
    [sg.Text('Enter the adress of the image:'),sg.InputText("", key='adress')],
    [sg.Text('Enter the key:'),sg.InputText("", key='code'),sg.Button(button_text='OK'),sg.Button(button_text='Exit')],
         ]
